...
def chapter3(D, figs):
    ...
    D.p("ขั้นตอนการเตรียมข้อมูลตั้งแต่ภาพดิบจนถึงพร้อมฝึก แสดงในภาพ 2")
    ...
    D.p("การกระจายของจำนวนตัวอย่างในแต่ละคลาสแสดงในภาพ 3 ซึ่งชี้ให้เห็นความไม่สมดุลของคลาส (Class "
    ...
    D.p("ระบบมีอินเทอร์เฟซ 2 ทาง คือ หน้าเว็บ (Gradio, app.py) และคำสั่งบรรทัด (CLI, pipeline.py) "
        "ซึ่งทั้งคู่เรียกใช้แกนประมวลผลเดียวกัน โครงสร้างโดยรวมแสดงในภาพ 4 และรายละเอียดภายในแต่ละขั้น "
        "ในภาพ 5 และภาพ 6")
    ...
    D.p("แผนผังลำดับขั้นตอนการทำงานของระบบหลักแสดงในภาพ 10 และขั้นตอนการปรับแต่งภาพในภาพ 11")
