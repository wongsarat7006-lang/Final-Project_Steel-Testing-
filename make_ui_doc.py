...
def main():
    ...
    doc.table(["สถานะ", "เงื่อนไข", "สี", "ข้อความหลัก"], [
        ...
        ["ไม่พบตำหนิ + อาจไม่ใช่เหล็ก",
         "ไม่พบตำหนิ และ Stage 0 (P(เหล็ก)<10%) + Stage 1 (โลหะ<2%) เงียบพร้อมกัน",
         "เขียว", "ไม่พบตำหนิพื้นผิว — พร้อมหมายเหตุว่าภาพนี้อาจไม่ใช่พื้นผิวเหล็ก "
         "(ทั้งสองตัว bias ไปภาพแล็บ จึงเป็นหมายเหตุ ไม่ใช่คำตัดสิน)"],
