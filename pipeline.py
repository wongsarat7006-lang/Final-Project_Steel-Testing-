...
# causes / advice = ข้อมูลอ้างอิงทั่วไปของตำหนิแต่ละชนิด (ไม่ใช่การวินิจฉัยชิ้นงานจริง)
DEFECT_INFO = {
    "crazing": {
        "name_th": "รอยแตกลายงา", "risk": "ปานกลาง-สูง",
        "causes": "ความเค้นตกค้างจากการเย็นตัวเร็วหลังรีดร้อน · ไฮโดรเจนแทรกในเนื้อเหล็ก (hydrogen embrittlement) · ผิวรับแรงเกินตอนขึ้นรูป",
        "advice": "ตรวจว่าเป็นรอยตื้นที่ผิวหรือร้าวลึก ถ้าเป็นร่างแหกว้างหรือลึกควรให้ผู้เชี่ยวชาญประเมินก่อนใช้งาน",
    },
    "inclusion": {
        "name_th": "สิ่งแปลกปลอมฝังใน", "risk": "ปานกลาง",
        "causes": "สิ่งเจือปน/สแลกในน้ำเหล็กตอนหลอม · เศษวัสดุทนไฟหลุดปนลงแบบ · การกำจัดออกซิเจนในน้ำเหล็กไม่สมบูรณ์",
        "advice": "ประเมินขนาดและความหนาแน่น จุดที่มี inclusion เป็นจุดอ่อนเฉพาะที่ ถ้าอยู่ในบริเวณรับแรงสำคัญควรคัดออก",
    },
    "patches": {
        "name_th": "รอยแผ่น/ผิวลอก", "risk": "ต่ำ-ปานกลาง",
        "causes": "การล้างกรด/กำจัดสเกลไม่สม่ำเสมอ · อุณหภูมิรีดไม่เท่ากันทั้งแผ่น · ออกไซด์ตกค้างเป็นหย่อม",
        "advice": "ส่วนใหญ่เป็นตำหนิผิว ทำความสะอาดแล้วตรวจซ้ำ แต่ให้เฝ้าระวังการเกิดสนิมใต้รอยลอก",
    },
    "pitted_surface": {
        "name_th": "ผิวขรุขระเป็นหลุม", "risk": "ปานกลาง",
        "causes": "ล้างกรดนานเกินไปจนกัดผิว (over-pickling) · สเกลถูกกดฝังแล้วหลุดออกตอนรีด · การกัดกร่อนระยะเริ่มต้น · ลูกรีดสึก",
        "advice": "วัดความลึกของหลุม หลุมเป็นจุดเริ่มการกัดกร่อนและสะสมความเค้นได้ ควรเคลือบผิวปิด",
    },
    "rolled-in_scale": {
        "name_th": "สะเก็ดฝังจากการรีด", "risk": "ปานกลาง",
        "causes": "กำจัดสเกลออกไม่หมดก่อนรีด · อุณหภูมิรีดต่ำเกินไป · หัวฉีดน้ำกำจัดสเกลสึก/อุดตัน",
        "advice": "มักอยู่แค่ที่ผิว ขัดออกได้ แต่ทำให้สีเคลือบไม่เกาะและเป็นจุดเริ่มสนิม",
    },
    "scratches": {
        "name_th": "รอยขีดข่วน", "risk": "ต่ำ",
        "causes": "ครูดกับขอบแข็ง/รางนำที่หยาบตอนขนย้าย · แท่นนำลูกรีดสึก · มีเศษของแข็งติดบนสายพาน",
        "advice": "รอยตื้นถือเป็นตำหนิผิว รอยลึกเป็นจุดสะสมความเค้น ควรเจียรให้เรียบ",
    },
    "rust": {
        "name_th": "สนิม", "risk": "สูง",
        "causes": "สัมผัสความชื้น/น้ำเป็นเวลานาน · ผิวเคลือบหรือสีกันสนิมเสียหาย · เก็บในที่อากาศชื้นหรือไอเค็ม",
        "advice": "ขัดสนิมออก ตรวจว่ากินลึกแค่ไหน แล้วเคลือบผิวใหม่ ถ้ากินลึกจนเนื้อบางต้องประเมินกำลังรับแรง",
    },
    "crack": {
        "name_th": "รอยแตกร้าว", "risk": "สูง",
        "causes": "รับแรงเกินพิกัด · ความล้าจากแรงกระทำซ้ำ ๆ (fatigue) · ข้อบกพร่องจากการเชื่อม/การหล่อ · เปราะจากความร้อนหรือไฮโดรเจน",
        "advice": "หยุดใช้งานชิ้นส่วนนั้น ให้ผู้เชี่ยวชาญประเมินก่อนนำกลับมาใช้ — เป็นตำหนิที่อันตรายที่สุด",
    },
}
